...
public partial class SettingsViewModel : ViewModelBase
{
    ...
    private async Task ResetDatabaseAsync()
    {
        ...
        try
        {
            ...
            var options = new DbContextOptionsBuilder<MoneyMapDbContext>()
                .UseSqlite($"Data Source={DatabasePath}")
                .Options;
            
            using var context = new MoneyMapDbContext(options);
    ...
    private async Task SeedDefaultCategoriesAsync(MoneyMapDbContext context)
    {
