...
{
    public static IServiceCollection AddMoneyMapData(this IServiceCollection services, string dbPath)
    {
        services.AddDbContext<MoneyMapDbContext>(options =>
    ...
    public static async Task InitializeDatabaseAsync(this IServiceProvider serviceProvider)
    {
        ...
        var context = scope.ServiceProvider.GetRequiredService<MoneyMapDbContext>();
    ...
    private static async Task SeedDefaultCategoriesAsync(MoneyMapDbContext context)
    {
        ...
        var defaultCategories = new[]
        {
            ...
            new Category { Name = "投资理财", Type = TransactionType.Expense, Icon = "💰", SortOrder = 8, SourceCategoryMapping = "投资理财,理财,基金,股票", AutoMatchPattern = "投资|理财|基金|股票|买入|申购" },
            ...
            new Category { Name = "投资收益", Type = TransactionType.Income, Icon = "📈", SortOrder = 3, SourceCategoryMapping = "投资收益,理财收益,利息,分红,收益发放", AutoMatchPattern = "收益|利息|分红|理财收益|收益发放|收益到账" },
            ...
            // Transfer categories
            new Category { Name = "理财转入", Type = TransactionType.Transfer, Icon = "🏦", SortOrder = 1, SourceCategoryMapping = "理财转入,余额宝,余利宝,零钱通,蚂蚁财富,理财通", AutoMatchPattern = "余额宝|余利宝|零钱通|蚂蚁财富|理财通|买入|申购|赎回" },
            new Category { Name = "转账", Type = TransactionType.Transfer, Icon = "🔄", SortOrder = 2, SourceCategoryMapping = "转账,转账-转账到零钱,转账-退款", AutoMatchPattern = "转账|提现|充值|转入|转出" },
            new Category { Name = "其他转账", Type = TransactionType.Transfer, Icon = "🔀", SortOrder = 99, SourceCategoryMapping = null, AutoMatchPattern = null },
        };
